...
internal class LoggingManager
{
    ...
    public LoggingManager()
    {
        ...
        Log.Logger = new LoggerConfiguration().MinimumLevel.ControlledBy(Logging.LevelSwitch).WriteTo
           .Async(o => o.Console(outputTemplate: consoleTemplate)).WriteTo.Async(o => o.Sink(stringWriterSink)).WriteTo
           .Async(o => o.File(formatter, logFile.FullName)).CreateLogger();
    }
